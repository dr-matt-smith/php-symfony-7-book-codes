...
class StudentController extends AbstractController
{
    ...
    public function update(int $id, string $newFirstName, string $newSurname, StudentRepository $studentRepository, ManagerRegistry $doctrine)
    {
...
//            );
    ...
    public function delete(int $id, StudentRepository $studentRepository, ManagerRegistry $doctrine)
    {
        $student = $studentRepository->find($id);
